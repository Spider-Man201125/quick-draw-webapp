...
document.getElementById('sketch_name').innerHTML = 'Sketch To be Drawn: ' + sketch; timer_counter = 0; 
}
timer_check = ""; 
drawn_sketch = ""; 
answer_holder = ""; 
...
function setup() { canvas = createCanvas(280, 280); canvas.center(); 
    background("white"); 
    function preload() { classifier = ml5.imageClassifier('DoodleNet'); 
} function setup() { canvas.mouseReleased(classifyCanvas); 
} function draw() { // Set stroke weight to 10 strokeWeight(13); 
    // Set stroke color to black stroke(0); 
